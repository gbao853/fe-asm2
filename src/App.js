...
const App = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const response = await axios.get('https://be-asm2.onrender.com/questions');
    ...
    useEffect(() => {
        const fetchQuizzes = async () => {
            try {
                const response = await axios.get('https://be-asm2.onrender.com/quizzes');
    ...
    const handleUpdateQuestion = async (updatedQuestion) => {
        try {
            await axios.put(`https://be-asm2.onrender.com/questions/${updatedQuestion._id}`, updatedQuestion);
